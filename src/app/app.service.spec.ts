  ...
  describe("#getFilmGallery", () => {
    ...
    it("should return expected film images (called once)", () => {
      ...
      appService
        .getFilmGallery()
        .subscribe(images =>
          expect(images).toEqual(dummyImages, "should return expected images")
        );
    ...
    it("should be OK returning no images", () => {
      ...
      appService
        .getFilmGallery()
        .subscribe(images =>
          expect(images.length).toEqual(0, "should have empty images array")
        );
    ...
    it("should turn 404 into an empty images result", () => {
      ...
      appService
        .getFilmGallery()
        .subscribe(images =>
          expect(images.length).toEqual(0, "should return empty images array")
        );
